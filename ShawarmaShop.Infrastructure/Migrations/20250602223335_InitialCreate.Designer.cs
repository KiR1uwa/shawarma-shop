...
namespace ShawarmaShop.Infrastructure.Migrations
{
    ...
    [Migration("20250602223335_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShawarmaShopCore.Models.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ShawarmaShopCore.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ShawarmaShopCore.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ShawarmaShopCore.Models.Shawarma", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ShawarmaShopCore.Models.Order", b =>
                {
                    b.HasOne("ShawarmaShopCore.Models.Client", "Client")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("ShawarmaShopCore.Models.OrderItem", b =>
                {
                    b.HasOne("ShawarmaShopCore.Models.Order", "Order")
                        .WithMany("Items")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ShawarmaShopCore.Models.Shawarma", "Shawarma")
                        .WithMany("OrderItems")
